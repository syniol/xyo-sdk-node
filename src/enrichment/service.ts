...
export class EnrichmentService implements Enrichment {
  ...
  public async enrichTransaction(request: EnrichmentRequest): Promise<EnrichmentResponse> {
    const resp = await this.clientConfig.httpRequest<EnrichmentResponse>(
  ...
  public async enrichTransactionCollection(request: EnrichmentRequest[]): Promise<EnrichTransactionCollectionResponse> {
    const resp = await this.clientConfig.httpRequest<EnrichTransactionCollectionResponse>(
  ...
  public async enrichTransactionCollectionStatus(id: string): Promise<EnrichmentCollectionStatus> {
    const resp = await this.clientConfig.httpRequest<EnrichTransactionCollectionStatusResponse>(
